...
public class StaffRepository {
	...
	public StaffModel findStaffByUserName(String name) {
		String sql = " SELECT "
				+ " e.emp_id,e.name_en,e.name_cn,e.email,e.create_time,e.entry_date,e.status,e.leave_date,e.password,e.last_name_en,e.last_name_cn,e.username,e.job_id,e.org_id,j.title,o.description organization"
